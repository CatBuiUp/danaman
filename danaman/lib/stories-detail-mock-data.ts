...
export const STORY_DETAILS_MOCK: Story[] = [
  {
    id: "mock-story-1",
    image:
  ...
  },
  {
    ...
    title: "Bữa Cơm Làng Chài",
    description: "Ăn cùng gia đình ngư dân, nghe chuyện đời biển Đà Nẵng.",
    content: [
      "Tại một gia đình ngư dân, cả gia đình đều tham gia để chia sẻ cảm xúc và kiến thức về đời sống biển.",
      "Các bữa cơm được chia sẻ với nhau, và cả gia đình đều tham gia để chia sẻ cảm xúc và kiến thức về đời sống biển.",
    ],
    quote: "Mỗi bữa cơm đều có một câu chuyện đầy cảm hứng.",
    author: "Ngư dân",
    authorAvatar:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80",
    publishedAt: "16/05/2024",
    location: "Nhà người dân tại làng chài ven biển",
